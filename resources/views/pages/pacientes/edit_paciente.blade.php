                ...
                <div class="card-body">
                    <form action="{{ route('pacientes.update', $paciente->id) }}" method="POST">
                        ...
                        <div class="form-group @error('nombre') has-danger @enderror">
                            ...
                            <input type="text" name="nombres" id="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre', $paciente->userDetalles[0]->nombres) }}" required>
                            @error('nombre')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group @error('apellido') has-danger @enderror">
                            ...
                            <input type="text" name="apellidos" id="apellido" class="form-control @error('apellido') is-invalid @enderror" value="{{ old('apellido', $paciente->userDetalles[0]->apellidos) }}" required>
                            @error('apellido')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group @error('fecha_nacimiento') has-danger @enderror">
                            ...
                            <input type="text" name="edad" id="edad" class="form-control @error('fecha_nacimiento') is-invalid @enderror" value="{{ old('edad', $paciente->userDetalles[0]->edad) }}" required>
                        ...
                        <div class="form-group @error('edad') has-danger @enderror">
                            <label for="edad">Edad</label>
                            <input type="number" name="edad" id="edad" class="form-control @error('edad') is-invalid @enderror" value="{{ old('edad', $paciente->userDetalles[0]->edad) }}" required>
                            @error('edad')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group @error('telefono') has-danger @enderror">
                            ...
                            <input type="text" name="telefono" id="telefono" class="form-control @error('telefono') is-invalid @enderror" value="{{ old('telefono', $paciente->userDetalles[0]->telefono) }}">
                            @error('telefono')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group @error('direccion') has-danger @enderror">
                            ...
                            <input type="text" name="direccion" id="direccion" class="form-control @error('direccion') is-invalid @enderror" value="{{ old('direccion', $paciente->userDetalles[0]->direccion) }}">
                            @error('direccion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group
                            ...
                            <select name="ciudad_id" id="ciudad_id" class="form-control select2 @error('ciudad') is-invalid @enderror" required>
                                <option value="">Seleccione...</option>
                                @foreach($ciudades as $ciudad)
                                    <option value="{{ $ciudad->id }}" {{ old('ciudad', $paciente->userDetalles[0]->ciudad_id) == $ciudad->id ? 'selected' : '' }}>{{ $ciudad->nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group
                        ...
                        <div class="form-group
                            ...
                            <select name="nivel_escolaridad_id" id="nivel_escolaridad_id" class="form-control @error('nivel_escolaridad_id') is-invalid @enderror select2">
                                <option value="">Seleccione...</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="antecedentes_personales" id="antecedentes_personales" class="form-control @error('antecedentes_personales') is-invalid @enderror" value="{{ old('antecedentes_personales', $paciente->userDetalles[0]->antecedentes_personales) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="antecedentes_familiares" id="antecedentes_familiares" class="form-control @error('antecedentes_familiares') is-invalid @enderror" value="{{ old('antecedentes_familiares', $paciente->userDetalles[0]->antecedentes_familiares) }}">
                        ...
                        <div class="form-group
                            ...
                            <input type="text" name="disimulacion" id="disimulacion" class="form-control @error('disimulacion') is-invalid @enderror" value="{{ old('disimulacion', $paciente->userDetalles[0]->disimulacion) }}">
                            @error('disimulacion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="simulacion" id="simulacion" class="form-control @error('simulacion') is-invalid @enderror" value="{{ old('simulacion', $paciente->userDetalles[0]->simulacion) }}">
                            @error('simulacion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="conciencia" id="conciencia" class="form-control @error('conciencia') is-invalid @enderror" value="{{ old('conciencia', $paciente->userDetalles[0]->conciencia) }}">
                            @error('conciencia')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="aspecto_del_paciente" id="aspecto_del_paciente @error('aspecto_del_paciente') is-invalid @enderror" class="form-control" value="{{ old('aspecto_del_paciente', $paciente->userDetalles[0]->aspecto_del_paciente) }}">
                            @error('aspecto_del_paciente')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="actitud" id="actitud" class="form-control @error('actitud') is-invalid @enderror" value="{{ old('actitud', $paciente->userDetalles[0]->actitud) }}">
                            @error('actitud')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="contacto_visual" id="contacto_visual" class="form-control @error('contacto_visual') is-invalid @enderror" value="{{ old('contacto_visual', $paciente->userDetalles[0]->contacto_visual) }}">
                            @error('contacto_visual')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group
                            ...
                            <input type="text" name="atencion_orientacion_temp_espa" id="atencion_orientacion_temp_espa" class="form-control @error('atencion_orientacion_temp_espa') is-invalid @enderror" value="{{ old('atencion_orientacion_temp_espa', $paciente->userDetalles[0]->atencion_orientacion_temp_espa) }}">
                            @error('atencion_orientacion_temp_espa')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="memoria" id="memoria" class="form-control @error('memoria') is-invalid @enderror" value="{{ old('memoria', $paciente->userDetalles[0]->memoria) }}">
                            @error('memoria')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="sensoperecepcion" id="sensoperecepcion" class="form-control @error('sensoperecepcion') is-invalid @enderror" value="{{ old('sensoperecepcion', $paciente->userDetalles[0]->sensoperecepcion) }}">
                            @error('sensoperecepcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="pensamiento" id="pensamiento" class="form-control @error('pensamiento') is-invalid @enderror" value="{{ old('pensamiento', $paciente->userDetalles[0]->pensamiento) }}">
                            @error('pensamiento')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="afectividad" id="afectividad" class="form-control @error('afectividad') is-invalid @enderror" value="{{ old('afectividad', $paciente->userDetalles[0]->afectividad) }}">
                            @error('afectividad')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="psicomotricidad" id="psicomotricidad" class="form-control @error('psicomotricidad') is-invalid @enderror" value="{{ old('psicomotricidad', $paciente->userDetalles[0]->psicomotricidad) }}">
                            @error('psicomotricidad')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="insigth" id="insigth" class="form-control @error('insigth') is-invalid @enderror" value="{{ old('insigth', $paciente->userDetalles[0]->insigth) }}">
                            @error('insigth')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="diagnostico_presuntivo" id="diagnostico_presuntivo" class="form-control @error('diagnostico_presuntivo') is-invalid @enderror" value="{{ old('diagnostico_presuntivo', $paciente->userDetalles[0]->diagnostico_presuntivo) }}">
                            @error('diagnostico_presuntivo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="diagnostico_diferencial" id="diagnostico_diferencial" class="form-control @error('diagnostico_diferencial') is-invalid @enderror" value="{{ old('diagnostico_diferencial', $paciente->userDetalles[0]->diagnostico_diferencial) }}">
                            @error('diagnostico_diferencial')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="plan_tratamiento" id="plan_tratamiento" class="form-control @error('plan_tratamiento') is-invalid @enderror" value="{{ old('plan_tratamiento', $paciente->userDetalles[0]->plan_tratamiento) }}" >
                            @error('plan_tratamiento')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="pronostico" id="pronostico" class="form-control @error('pronostico') is-invalid @enderror"  value="{{ old('pronostico', $paciente->userDetalles[0]->pronostico) }}" >
                            @error('pronostico')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="evolucion" id="evolucion" class="form-control @error('evolucion') is-invalid @enderror" value="{{ old('evolucion', $paciente->userDetalles[0]->evolucion) }}">
                            @error('evolucion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group
                            ...
                            <input type="text" name="epicrisis" id="epicrisis" class="form-control @error('epicrisis') is-invalid @enderror" value="{{ old('epicrisis', $paciente->userDetalles[0]->epicrisis) }}">
                            @error('epicrisis')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
