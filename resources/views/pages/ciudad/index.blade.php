            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        font-weight-bold">LISTA DE CIUDADES</h4>
                            <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                                <a href="{{ route('ciudades.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-solid fa-plus"></i></a>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @foreach($ciudades as $ciudad)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('ciudades.edit', $ciudad->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-solid fa-pen"></i></a>
