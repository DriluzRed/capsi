            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        font-weight-bold">LISTA DE INGRESOS</h4>
                            <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                                <a href="{{ route('ingresos.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-solid fa-plus"></i></a>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @foreach($ingresos as $ingreso)
                                                <tr>
                                                    ...
                                                    <td>{{ $ingreso->fecha }}</td>
                                                    <td decimal-mask>{{ number_format($ingreso->total, 0, ',', '.') }} Gs.</td>
                                                    <td>
                                                        <a href="{{ route('ingresos.edit', $ingreso->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-solid fa-pen"></i></a>
