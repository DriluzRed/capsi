            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        font-weight-bold">LISTA DE PROFESIONES</h4>
                            <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                                <a href="{{ route('profesiones.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-solid fa-plus"></i></a>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @foreach($profesiones as $profesion)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('profesiones.edit', $profesion->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-solid fa-pen"></i></a>
