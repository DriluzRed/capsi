            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        font-weight-bold">LISTA DE SITUACION LABORAL</h4>
                            <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                                <a href="{{ route('situacionLaboral.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-solid fa-plus"></i></a>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @foreach($situacionLaboral as $situacionLaboral)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('situacionLaboral.edit', $situacionLaboral->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-solid fa-pen"></i></a>
